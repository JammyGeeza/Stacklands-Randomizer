...
namespace Stacklands_Randomizer_Mod
{
    public static class CustomQuestMapping
    {
        ...
        public static readonly List<Quest> Mainland = new()
        {
            ...
            new($"build_{Cards.animal_pen}")            { OnActionComplete = (CardData card, string action) => card.Id == Cards.blueprint_animalpen && action == "finish_blueprint"         , PossibleInPeacefulMode = true     , QuestGroup = EnumExtensionHandler.StructuresanityQuestGroupEnum },
            new($"build_{Cards.breeding_pen}")          { OnActionComplete = (CardData card, string action) => card.Id == Cards.blueprint_breedingpen && action == "finish_blueprint"       , PossibleInPeacefulMode = true     , QuestGroup = EnumExtensionHandler.StructuresanityQuestGroupEnum },
            new($"build_{Cards.slaughter_house}")       { OnActionComplete = (CardData card, string action) => card.Id == Cards.blueprint_slaughterhouse && action == "finish_blueprint"    , PossibleInPeacefulMode = true     , QuestGroup = EnumExtensionHandler.StructuresanityQuestGroupEnum },
            ...
            new($"build_{Cards.conveyor}")              { OnActionComplete = (CardData card, string action) => card.Id == Cards.blueprint_conveyor && action == "finish_blueprint"          , PossibleInPeacefulMode = true     , QuestGroup = EnumExtensionHandler.StructuresanityQuestGroupEnum },
            new($"build_{Cards.trash_can}")             { OnActionComplete = (CardData card, string action) => card.Id == Cards.blueprint_trash_can && action == "finish_blueprint"         , PossibleInPeacefulMode = true     , QuestGroup = EnumExtensionHandler.StructuresanityQuestGroupEnum },
            ...
            new($"build_{Cards.university}")            { OnActionComplete = (CardData card, string action) => card.Id == Cards.blueprint_university && action == "finish_blueprint"        , PossibleInPeacefulMode = true     , QuestGroup = EnumExtensionHandler.StructuresanityQuestGroupEnum },
        ...
        public static readonly List<Quest> Island = new()
        {
            ...
            new($"build_{Cards.aquarium}")              { OnActionComplete = (CardData card, string action) => card.Id == Cards.blueprint_aquarium && action == "finish_blueprint"                                                              , PossibleInPeacefulMode = true     , QuestGroup = EnumExtensionHandler.StructuresanityQuestGroupEnum },
            ...
            new($"build_{Cards.heavy_foundation}")      { OnActionComplete = (CardData card, string action) => card.Id == Cards.blueprint_heavy_foundation && action == "finish_blueprint"                                                      , PossibleInPeacefulMode = true     , QuestGroup = EnumExtensionHandler.StructuresanityQuestGroupEnum },
            new($"build_{Cards.resource_magnet}")       { OnActionComplete = (CardData card, string action) => card.Id == Cards.blueprint_resource_magnet && action == "finish_blueprint"                                                       , PossibleInPeacefulMode = true     , QuestGroup = EnumExtensionHandler.StructuresanityQuestGroupEnum },
            ...
            new($"build_{Cards.wishing_well}")          { OnActionComplete = (CardData card, string action) => card.Id == Cards.blueprint_wishing_well && action == "finish_blueprint"                                                          , PossibleInPeacefulMode = true     , QuestGroup = EnumExtensionHandler.StructuresanityQuestGroupEnum },
