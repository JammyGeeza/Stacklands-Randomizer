...
namespace Stacklands_Randomizer_Mod
{
    public static class ItemMapping
    {
        public static readonly List<Item> Map = new()
        {
            ...
            // Resource Bundles
            new() { Name = "Apple Tree x3"      , ItemId = Cards.apple_tree     , ItemType = ItemType.Resource, Amount = 3 },
            new() { Name = "Berry x5"           , ItemId = Cards.berry          , ItemType = ItemType.Resource, Amount = 5 },
            new() { Name = "Berry Bush x3"      , ItemId = Cards.berrybush      , ItemType = ItemType.Resource, Amount = 3 },
            ...
            new() { Name = "Coin x25"           , ItemId = Cards.gold           , ItemType = ItemType.Resource, Amount = 25},
            new() { Name = "Egg x5"             , ItemId = Cards.egg            , ItemType = ItemType.Resource, Amount = 5 },
            new() { Name = "Flint x5"           , ItemId = Cards.flint          , ItemType = ItemType.Resource, Amount = 5 },
            new() { Name = "Iron Deposit x3"    , ItemId = Cards.iron_deposit   , ItemType = ItemType.Resource, Amount = 3 },
            new() { Name = "Iron Ore x5"        , ItemId = Cards.iron_ore       , ItemType = ItemType.Resource, Amount = 5 },
            new() { Name = "Milk x5"            , ItemId = Cards.milk           , ItemType = ItemType.Resource, Amount = 5 },
            new() { Name = "Rock x3"            , ItemId = Cards.rock           , ItemType = ItemType.Resource, Amount = 3 },
            new() { Name = "Stick x5"           , ItemId = Cards.stick          , ItemType = ItemType.Resource, Amount = 5 },
            new() { Name = "Stone x5"           , ItemId = Cards.stone          , ItemType = ItemType.Resource, Amount = 5 },
            new() { Name = "Tree x3"            , ItemId = Cards.tree           , ItemType = ItemType.Resource, Amount = 3 },
